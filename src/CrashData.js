$.fn.CrashDataTable = function(e, t, a) {
  ...
  if(e.ButtonHeader){
   ...
   let BtnExportData = [];
   console.log(ConfBExcel.length);
   if (ConfBExcel) {
    BtnExportData.push(ConfBExcel);
   }

   if (ConfBPdf) {
    BtnExportData.push(ConfBPdf);
   }

   if (ConfCopyData) {
    BtnExportData.push(ConfCopyData);
   }

   if (ConfBAddData) {
    BtnExportData.push(ConfBAddData);
   }
      CbTables = {
          dom: "Bfrtip",
          buttons: {
      ...
      s = {
          ...
          rowGroup: {
              ...
              startRender: function(rows, group) {
                ...
                return $('<tr/>')
        .append('<td colspan="'+ConfGroup.GroupRowSpan+'" class="group bg-secondary '+ConfGroup.FontColor +' collapse-crash">'+svgdata+'  '
         + group + ' (' + rows.count() + ')</td>')
      ...
      s = {
          ...
          drawCallback: function(t) {
              ...
              a.column(ConfGroup.GroupsColumn, {
                  ...
                  if (n !== e) {
                      $(o).eq(t).before('<tr class="group bg-secondary '+ConfGroup.FontColor  +'" data-f-color="f9f9f9" data-fill-color="000000" ><td style="font-size: 15px;" colspan="'+ConfGroup.GroupRowSpan+'">' + e + "</td></tr>");
                      n = e
                  }
              }))
          }
